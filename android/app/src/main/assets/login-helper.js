  ...
  document.body.insertAdjacentHTML('beforeend', `
    <style>
      ...
      *{box-sizing:border-box}html,body{margin:0;min-height:100%;font-family:"SF Pro Display","Segoe UI","Microsoft YaHei",sans-serif;color:var(--ink);letter-spacing:0}
      ...
      @media(max-width:820px){.scene{min-height:100vh;background-position:56% 34%}.left-rail{top:14px;bottom:14px;left:14px;width:min(360px,calc(100vw - 28px))}.identity{padding:17px}.brand{font-size:15px}.brand img{width:40px;height:40px}.copy{display:none}.login-panel{padding:23px}.login-bottom-actions{right:14px;bottom:14px;gap:8px}.action-btn,.background-customize{height:40px;padding:0 12px;font-size:12px}.crop-dialog{width:calc(100vw - 28px);padding:16px}.crop-actions{align-items:stretch;flex-direction:column}.crop-actions-left,.crop-actions-right{display:grid;grid-template-columns:1fr 1fr}.crop-button{padding:0 11px}}
    </style>
