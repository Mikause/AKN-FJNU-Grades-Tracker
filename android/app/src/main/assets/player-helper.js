(() => {
  ...
  style.textContent = `
    #akn-player{position:fixed;right:20px;bottom:82px;z-index:2147483644;width:300px;color:#183547;font-family:"SF Pro Display","Segoe UI","Microsoft YaHei",sans-serif;letter-spacing:0}
    #akn-player *{box-sizing:border-box}#akn-player .pp-shell{overflow:hidden;border:1px solid rgba(255,255,255,.68);border-radius:18px;background:var(--glass-bg, linear-gradient(145deg,rgba(246,251,252,.68),rgba(218,235,242,.42)));box-shadow:0 18px 44px rgba(12,37,51,.2),inset 0 1px rgba(255,255,255,.88);backdrop-filter:blur(var(--glass-blur, 22px)) saturate(155%);-webkit-backdrop-filter:blur(var(--glass-blur, 22px)) saturate(155%);transition:backdrop-filter .2s ease,background .2s ease}
    .pp-main{height:64px;padding:8px 10px;display:grid;grid-template-columns:38px 1fr auto;align-items:center;gap:9px}.pp-button{width:36px;height:36px;padding:0;display:inline-flex;align-items:center;justify-content:center;border:1px solid rgba(255,255,255,.72);border-radius:11px;background:rgba(255,255,255,.34);box-shadow:inset 0 1px rgba(255,255,255,.72),0 4px 12px rgba(24,72,91,.08);color:#1b6078;cursor:pointer;transition:transform .16s ease,background .16s ease,box-shadow .16s ease,color .16s ease}.pp-button:hover{transform:translateY(-1px);background:rgba(255,255,255,.66);box-shadow:inset 0 1px white,0 7px 16px rgba(24,72,91,.13)}.pp-button:active{transform:translateY(0) scale(.95)}.pp-button:focus-visible{outline:2px solid var(--accent, rgba(8,127,140,.5));outline-offset:2px}.pp-icon{width:17px;height:17px;display:block;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.pp-play{color:white;border-color:rgba(255,255,255,.58);background:var(--accent-gradient, linear-gradient(135deg,rgba(5,151,155,.96),rgba(29,104,158,.92)));box-shadow:inset 0 1px rgba(255,255,255,.42),0 7px 18px var(--accent-glow, rgba(12,106,132,.24))}.pp-play:hover{filter:brightness(1.05)}.pp-play .pp-icon{width:18px;height:18px}.pp-info{min-width:0}.pp-title{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:700}.pp-time{margin-top:3px;color:#617786;font-size:10px}.pp-actions{display:flex;gap:5px}.pp-actions .pp-button{width:31px;height:31px}.pp-actions .pp-icon{width:15px;height:15px}
    .pp-progress-wrap{padding:0 24px 10px}.pp-progress{--pp-progress:0%;width:100%;height:14px;margin:-2px 0 0;display:block;appearance:none;-webkit-appearance:none;background:transparent;cursor:pointer}.pp-progress::-webkit-slider-runnable-track{height:3px;border-radius:99px;background:linear-gradient(90deg,var(--accent, rgba(18,139,151,.92)) 0 var(--pp-progress),rgba(255,255,255,.56) var(--pp-progress) 100%)}.pp-progress::-webkit-slider-thumb{width:14px;height:14px;margin-top:-5.5px;border:2px solid rgba(255,255,255,.82);border-radius:50%;appearance:none;-webkit-appearance:none;background:var(--accent, #168995);box-shadow:0 2px 7px rgba(17,87,104,.22)}.pp-panel{display:none;padding:10px;border-top:1px solid rgba(255,255,255,.48)}#akn-player.open .pp-panel{display:block}.pp-toolbar{display:grid;grid-template-columns:31px 1fr 31px 31px;align-items:center;gap:7px}.pp-toolbar .pp-button{width:31px;height:31px}.pp-toolbar .pp-icon{width:15px;height:15px}.pp-volume{width:100%;accent-color:var(--accent, #168591)}.pp-mode.active{color:white;background:var(--accent-gradient, linear-gradient(135deg,rgba(5,137,145,.92),rgba(30,106,153,.88)))}.pp-list{max-height:150px;margin:9px 0 0;padding:0;overflow:auto;list-style:none}.pp-track{width:100%;height:34px;padding:0 9px;display:flex;align-items:center;gap:7px;border:0;border-radius:9px;background:transparent;color:#294758;font:12px inherit;text-align:left;cursor:pointer}.pp-track:hover,.pp-track.active{background:rgba(255,255,255,.45)}.pp-track.active{font-weight:700;color:var(--accent, #087f8c)}.pp-dot{width:6px;height:6px;flex:none;border-radius:50%;background:currentColor}.pp-add{width:100%;height:34px;margin-top:8px;display:flex;align-items:center;justify-content:center;gap:7px;border:1px dashed rgba(30,93,114,.35);border-radius:9px;background:rgba(255,255,255,.22);color:#31566a;font:650 11px inherit;cursor:pointer;transition:background .16s ease,border-color .16s ease}.pp-add:hover{background:rgba(255,255,255,.46);border-color:var(--accent, rgba(8,127,140,.48))}.pp-add .pp-icon{width:14px;height:14px}.pp-file{display:none!important}
    body:has(.background-editor.open) #akn-player{display:none}body:has(#akn-ui-drawer.open) #akn-player{opacity:.35;pointer-events:none;transition:opacity .2s}@media(max-width:620px){#akn-player{right:12px;bottom:72px;width:min(300px,calc(100vw - 24px))}}
  `;
