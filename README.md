...
学校教务系统不仅页面古老且操作繁琐，于是便基于EdgeWebView2在Antigravity的帮助下做了这个轻量桌面工具：保留了官方登录与接口安全，同时重构了视觉呈现——换上清爽的毛玻璃界面，顺便塞入了一个支持播放本地音乐的悬浮播放器和自定义壁纸裁切器，让查分体验变得更加舒适。
...
<p align="center">
  <img src="assets/Demo.png" alt="粥粥FJNU成绩查询 界面预览" width="850" />
</p>
