...
每到期末查分季，学校教务系统不仅页面古老、操作繁琐，而且查分时的长时间等待总让人心慌。  
于是便基于 Edge WebView2 顺手做了这个轻量桌面工具：保留了官方登录与接口安全，同时重构了视觉呈现——换上清爽的毛玻璃界面，顺便塞入了一个支持播放本地音乐的悬浮播放器和自定义壁纸裁切器，让查分体验变得更加舒适。
